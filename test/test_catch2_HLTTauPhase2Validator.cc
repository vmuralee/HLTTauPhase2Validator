...
static constexpr auto s_tag = "[HLTTauPhase2Validator]";

TEST_CASE("Standard checks of HLTTauPhase2Validator", s_tag) {
  const std::string baseConfig{
      R"_(from FWCore.TestProcessor.TestProcess import *
process = TestProcess()
process.toTest = cms.EDProducer("HLTTauPhase2Validator"
